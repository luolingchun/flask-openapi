...
**Flask OpenAPI** 是一个基于 **Flask** 的 web API 框架，使用 **Pydantic** 验证数据，自动生成交互文档。
...
- [flask-openapi-plugins](https://github.com/luolingchun/flask-openapi-plugins) 为 flask-openapi 提供 OpenAPI UI.

和 flask-openapi 一起安装这些依赖:
...
这里有一个简单的示例，更多示例请查看[示例](https://luolingchun.github.io/flask-openapi/latest/zh/Example/)。
...
运行[简单示例](https://github.com/luolingchun/flask-openapi/blob/master/examples/simple_demo.py)
，然后访问 http://127.0.0.1:5000/openapi。

> OpenAPI UI插件是需要手动安装的可选依赖项。
>
> `pip install -U flask-openapi[swagger,redoc,rapidoc,rapipdf,scalar,elements]`
>
> 更多可选[UI模板](https://luolingchun.github.io/flask-openapi/latest/Usage/UI_Templates/)
